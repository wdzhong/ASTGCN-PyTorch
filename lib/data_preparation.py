...
def read_and_generate_dataset(graph_signal_matrix_filename,
    ...
    """
    # wd: if there are 60 days, then 60 * 24 * 12 = 17280, which is close to 16992
    ...
    for idx in range(data_seq.shape[0]):
        ...
        all_samples.append((
            ...
            np.expand_dims(target, axis=0).transpose((0, 2, 3, 1))[:, :, 0, :]  # wd: first feature is the traffic flow
        ))
